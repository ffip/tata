...
var (
	// Epoch is set to the twitter snowflake epoch of Dec 12 2012 12:12:12 UTC in milliseconds
	// You may customize this to set a different epoch for your application.
	Epoch int64 = 1355285532000
...
func NewNode(node int64) (*Node, error) {
	...
	// reverseproxy-calc in case custom NodeBits or StepBits were set
